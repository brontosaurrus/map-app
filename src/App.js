    ...
    return (
      ...
      <div className="App">
        ...
        <Map center={[ -37.8470585,145.1145445]} zoom={12} width={600} height={400}>
          ...
          {this.state.events.map(i=>  (<Marker
            anchor={[i.the_geom.coordinates[0][0][0][1],i.the_geom.coordinates[0][0][0][0]]}
            payload={i}
            onClick={this.handleMarkerClick}/>))}
        </Map>)
        {this.state.selectedIcon && JSON.stringify(this.state.selectedIcon)} 
      </div>
      )
    }
    statusChanged = (e) =>
